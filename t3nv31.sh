...
function restart_node() {
    ...
    export ENABLED_NETWORKS='arbitrum-sepolia,base-sepolia,blast-sepolia,optimism-sepolia,l1rn'
    export RPC_ENDPOINTS_L1RN='https://brn.rpc.caldera.xyz/'
    export RPC_ENDPOINTS_ARBT='https://arb-sepolia.g.alchemy.com/v2/1eqwXTKUEqyCWfMR0xCEnGjPoFC-g7kD'
    export RPC_ENDPOINTS_BSSP='https://base-sepolia.g.alchemy.com/v2/1eqwXTKUEqyCWfMR0xCEnGjPoFC-g7kD'
    export RPC_ENDPOINTS_BLSS='https://blast-sepolia.g.alchemy.com/v2/1eqwXTKUEqyCWfMR0xCEnGjPoFC-g7kD'
    export RPC_ENDPOINTS_OPSP='https://opt-sepolia.g.alchemy.com/v2/1eqwXTKUEqyCWfMR0xCEnGjPoFC-g7kD'
...
function execute_script() {
    ...
    export RPC_ENDPOINTS_OPSP='https://opt-sepolia.g.alchemy.com/v2/1eqwXTKUEqyCWfMR0xCEnGjPoFC-g7kD'
    export EXECUTOR_PROCESS_PENDING_ORDERS_FROM_API=false
    export EXECUTOR_MAX_L3_GAS_PRICE=20
